                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h4 class="my-2 " style="text-transform: capitalize">
                                ...
                                <a href="{{route('luyo')}}" class="btn btn-primary float-end my-1 me-1 btn-sm">Back</a>
                                <a href="{{route('EditBillClientLuyo', [$clientbill->id])}}" class="btn btn-success float-end my-1 me-1 btn-sm">Edit</a>
                            </h4>
                        </div>
                        <div class="card-body">
